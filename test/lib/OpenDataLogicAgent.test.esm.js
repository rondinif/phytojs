...
nocktest('wdSearchByAnyName_uses_wikidata_api', async assert => {
	// Arrange
...
nocktest('wdSearchByAnyName_could_return_an_empty_list', async assert => {
	// Arrange
	//	 ...due to syntax requirements the management of fixtures is outside this code block
...
nocktest('wdSearchByAnyName_could_be_called_with_terms_in_any_language', async assert => {
	// Arrange
	//	 ...due to syntax requirements the management of fixtures is outside this code block
...
nocktest('wdSearchByAnyName_could_be_called_with_multi_words_terms_in_any_language', async assert => {
	// Arrange
	//	 ...due to syntax requirements the management of fixtures is outside this code block
...
// TEST: wdPlantsByAnyName has some common requirents for many use case; wdPlantsByAnyNameCommonAssertions collect these requirements so the test case can reuse it
...
// TEST: wdPlantsByAnyName should filter the wikidata api results so that the final result contains only useful entities possibly in the domain of plants
...
nocktest('wdPlantsByAnyName_uses_wikidata_api_filtering_possible_plants', async assert => {
	// Arrange
	//	 ...due to syntax requirements the management of fixtures is outside this code block
	const searchTerm = 'anguria';
	console.log(`search term: "${searchTerm}"`);
...
nocktest('wdPlantsByAnyName_could_return_an_empty_list', async assert => {
	// Arrange
	//	 ...due to syntax requirements the management of fixtures is outside this code block
	const searchTerm = 'bietola da coste';
	console.log(`search term: "${searchTerm}"`);
...
nocktest('wdPlantsByAnyName_uses_wikidata_api_filtering_possible_plants_in_any_language', async assert => {
	// Arrange
	//	 ...due to syntax requirements the management of fixtures is outside this code block
	const searchTerm = 'Ангурия';
	console.log(`search term: "${searchTerm}"`);
...
nocktest('wdPlantsByAnyName_uses_wikidata_api_filtering_possible_plants_searched_for_multi_words_terms_in_any_language', async assert => {
	// Arrange
	//	 ...due to syntax requirements the management of fixtures is outside this code block
	const searchTerm = 'Surinaamse wilde augurk';
	console.log(`search term: "${searchTerm}"`);
...
function resolvedPlantsByNameCommonAssertions(assert, searchTerm, queryResult, hasPlants) {
	assert.equal(queryResult.name, searchTerm, 'the json response has a "name" key which value equals to the searched term');
	const shouldExpectSomePlants = (hasPlants === undefined) ?	true : hasPlants;	// Default
	if (shouldExpectSomePlants) {
...
// TEST: resolvedPlantsByName should filter the the results so that it contains only useful entities possibly in the domain of plants
...
nocktest('resolvedPlantsByName_returns_plants_only', async assert => {
	// Arrange
	//	 ...due to syntax requirements the management of fixtures is outside this code block
...
nocktest('resolvedPlantsByName_can_return_plants_with_an_undefined_image', async assert => {
	// Arrange
	//	 ...due to syntax requirements the management of fixtures is outside this code block
...
nocktest('resolvedPlantsByName_could_return_an_empty_list', async assert => {
	// Arrange
	//	 ...due to syntax requirements the management of fixtures is outside this code block
	const searchTerm = 'bietola da coste';
	console.log(`search term: "${searchTerm}"`);
...
nocktest('resolvedPlantsByName_looks_for_names_in_any_language', async assert => {
	// Arrange
	//	 ...due to syntax requirements the management of fixtures is outside this code block
	const searchTerm = 'Ангурия';
	console.log(`search term: "${searchTerm}"`);
...
nocktest('resolvedPlantsByName_looks_for_plants_being_able_to_search_multi_words_terms_in_any_language', async assert => {
	// Arrange
	//	 ...due to syntax requirements the management of fixtures is outside this code block
	const searchTerm = 'Surinaamse wilde augurk';
	console.log(`search term: "${searchTerm}"`);
...
nocktest('sparqlScientificNameById_return_proper_scientific_name_for_a_valid_entity_id', async assert => {
	// Arrange
	//	 ...due to syntax requirements the management of fixtures is outside this code block
...
nocktest('sparqlScientificNameById_empty_for_entity_id_that_isnt_a_taxon', async assert => {
	// Arrange
	//	 ...due to syntax requirements the management of fixtures is outside this code block
