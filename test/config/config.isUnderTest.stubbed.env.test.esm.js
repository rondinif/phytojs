...
test('isUnderTest() should respond even if`IS_UNDER_TEST` environment setting is missing.', assert => {
...
test('isUnderTest() should respond consistently with `IS_UNDER_TEST` environment setting.', assert => {
	const sandbox = sinon.createSandbox();
